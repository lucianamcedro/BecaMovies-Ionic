...
import { RecentmoviesService } from '../projects/api/service/recentmovies.service';
...
export class Tab1Page implements OnInit {
  ...
  constructor(private service: RecentmoviesService) { }
  ...
  loadPoplarContainer() {
    this.service.getPopularList(this.modelType, this.page, this.filteredGenreId).subscribe(poplarMoviesEl => {
  ...
  cardEventListener(modelItem) {
    forkJoin(this.service.getDetailsList(this.modelType, modelItem.id),
